...
class StompService {
    ...
    unsubscribe(destination) {
        if (this.subscriptions[destination] && this.isConnect) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.isConnect) {
                if (!this.subscriptions[destination]) {
                    this.subscriptions[destination] = this.client.subscribe(destination, (msg) => {
...
const stompService = new StompService('http://localhost:8080/ws-connect-js');
